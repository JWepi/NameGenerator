...
class Policy(Policy):
    ...
    def load(self):
        ...
        #Name of the policy
        self.name = 'Policy eight - long words - average configuration with massive looping for fulfilling DB with long words'